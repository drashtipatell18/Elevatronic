                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-borderless">
                                        <tbody>
                                        <tr>
                                            <td class="text-gris" style="vertical-align: top !important;">Firma del representante</td>
                                            <td>
                                                <img src="{{ asset('img/fondo.png') }}" alt="img" width="233">
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="box-contenido contenido-elevatronic">
                                    ...
                                    <button id="uploadButton10" class="btn-gris"><i class="fas fa-arrow-to-top mr-2"></i> Subir Imagen</button>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <div class="box-contenido contenido-elevatronic">
                                    ...
                                    <input type="file" id="fileUpload" accept=".pdf,.xlsx,.xls,.doc,.docx" multiple class="d-none">
                                    <button id="uploadButton11" class="btn-gris mt-4"><i class="fas fa-arrow-to-top mr-2"></i> Cargar archivo</button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="limpieza" name="limpieza" disabled>
                                                    <label class="custom-control-label" for="limpieza"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="lubricacion" name="lubricacion" checked disabled>
                                                    <label class="custom-control-label" for="lubricacion"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="ajustes" name="ajustes" disabled>
                                                    <label class="custom-control-label" for="ajustes"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="revision" name="revision" disabled>
                                                    <label class="custom-control-label" for="revision"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="cambio" name="cambio" disabled>
                                                    <label class="custom-control-label" for="cambio"></label>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="solicitud" name="solicitud" disabled>
