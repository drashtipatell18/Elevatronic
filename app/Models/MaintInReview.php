...
class MaintInReview extends Model
{
    ...
    protected $fillable = ['tipo_de_revisión','ascensor','dirección','provincia','núm_certificado','supervisor_id','técnico','mes_programado','fecha_de_mantenimiento','hora_inicio','hora_fin','observaciónes','observaciónes_internas','solución'];
